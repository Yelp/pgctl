...
latex_documents = [
    (master_doc, 'pgctl.tex', u'pgctl Documentation',
     u'Buck Evan', 'manual'),
]
...
man_pages = [
    (master_doc, 'pgctl', u'pgctl Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pgctl', u'pgctl Documentation',
     author, 'pgctl', 'One line description of project.',
     'Miscellaneous'),
]
